class BacklightService extends Service {
    ...
    constructor() {
        ...
        const interface = Utils.exec("sh -c 'ls -w1 /sys/class/backlight | head -1'")
        const brightnessFile = `/sys/class/backlight/${interface}/brightness`

        Utils.monitorFile(brightnessFile, () => this.#onFileChange())
